<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addProfessor.aspx.cs" Inherits="EnglishProject.addProfessor" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="row">
                ...
                <asp:Button ID="deleteButton" runat="server" Text="Delete selected Professor" OnClick="deleteSelectedProfessor" class="btn btn-success" /><br />
